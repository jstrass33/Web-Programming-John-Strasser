...
<div class="row">
    ...
    <div class="col-sm">
        <img src="/static/hiddenlake.JPG" alt="Banff National Park" class="img-fluid float-left img-thumbnail"/>
    ...
    <div class="col-sm">
        <img src="/static/flowers_NC.JPG" alt="Banff National Park - Moraine Lake" class="img-fluid float-left img-thumbnail"/>
    ...
    <div class="col-sm">
        <img src="/static/walking_NC.JPG" alt="Banff National Park - Peyton Lake" class="img-fluid float-left img-thumbnail"/>
